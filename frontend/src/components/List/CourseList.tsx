      ...
      <div className="overflow-x-auto rounded-box mt-4 text-black">
        <table className="table w-full">
          ...
          <tbody className="text-sm sm:text-base">
            {[
              { id: 1, name: "Cy Ganderton", shift: "Morning", faculty: "Science" },
              { id: 2, name: "Alex Johnson", shift: "Day", faculty: "Commerce" },
              { id: 3, name: "Maria Lopez", shift: "Day", faculty: "Arts" },
              { id: 4, name: "John Doe", shift: "Morning", faculty: "Science" },
            ].map((student) => (
